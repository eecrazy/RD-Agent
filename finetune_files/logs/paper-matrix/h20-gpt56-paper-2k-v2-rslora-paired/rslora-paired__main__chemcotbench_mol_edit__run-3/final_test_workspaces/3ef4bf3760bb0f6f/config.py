...
with read_base():
    ...
    from opencompass.configs.datasets.chemcotbench.chemcotbench_mol_edit_gen import *
...
models = [
    dict(
        ...
        model_kwargs=dict(
            ...
            enable_lora=True,
            # Older in-flight workers do not provide max_lora_rank.  The
            # fallback keeps their generated configs compatible with the
            # largest LoRA rank allowed by the training prompt.
            max_lora_rank=64,
            max_cpu_loras=1,
