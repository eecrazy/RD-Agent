...
models = [
    dict(
        ...
        abbr="base-qwen2.5-7b-instruct-panorama_par4pc",
...
# ==================== Work Directory ====================
work_dir = "/data/github/RD-Agent/finetune_files/logs/paper-base/h20-gpt56-base-v1/base__7b__panorama_par4pc/validation"
