...
models = [
    dict(
        ...
        abbr="base-qwen2.5-7b-instruct-tablebench_data_analysis",
...
# ==================== Work Directory ====================
work_dir = "/data/github/RD-Agent/finetune_files/logs/paper-base/h20-gpt56-base-v1/base__7b__tablebench_data_analysis/validation"
